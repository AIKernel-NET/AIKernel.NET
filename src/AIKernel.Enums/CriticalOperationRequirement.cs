...
public enum CriticalOperationRequirement
{
    ...
    Unknown = 0,
    /// <summary>EN: Gets the HumanApproval value exposed by the AIKernel public contract surface. JA: AIKernel の公開契約サーフェスで公開される HumanApproval 値を取得します。</summary>
    HumanApproval = 1,
    ...
    Sandbox = 2,
    /// <summary>EN: Gets the Snapshot value exposed by the AIKernel public contract surface. JA: AIKernel の公開契約サーフェスで公開される Snapshot 値を取得します。</summary>
    Snapshot = 3,
    ...
    ReadOnly = 4,
    /// <summary>EN: Gets the RestrictScope value exposed by the AIKernel public contract surface. JA: AIKernel の公開契約サーフェスで公開される RestrictScope 値を取得します。</summary>
    RestrictScope = 5,
    ...
    NoExecution = 6,
    /// <summary>EN: Gets the ReplayRequired value exposed by the AIKernel public contract surface. JA: AIKernel の公開契約サーフェスで公開される ReplayRequired 値を取得します。</summary>
    ReplayRequired = 7
}
