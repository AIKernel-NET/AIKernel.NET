...
/// [EN] Documents this public package API member. [JA] ContextType の公開契約を定義します。
/// </summary>
...
public enum ContextType
{
    ...
    /// [EN] Documents this public package API member. [JA] Orchestration 値を表します。
    /// </summary>
    Orchestration = 1,
    ...
    /// [EN] Documents this public package API member. [JA] Material 値を表します。
    /// </summary>
    Material = 3
}
