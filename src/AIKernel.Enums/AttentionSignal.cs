...
/// EN: Documentation for public API. JA: AttentionSignal の公開契約を定義します。
/// </summary>
...
public enum AttentionSignal
{
    ...
    /// EN: Documentation for public API. JA: PurposePriority 値を表します。
    /// </summary>
    PurposePriority = 1,

    /// <summary>
    /// EN: Signal - 制約条件（attention の優先対象）
    /// EN: Documentation for public API. JA: ConstraintsPriority 値を表します。
    /// </summary>
    ConstraintsPriority = 2,

    /// <summary>
    /// EN: Signal - 抽象構造（attention の優先対象）
    /// EN: Documentation for public API. JA: StructurePriority 値を表します。
    /// </summary>
    StructurePriority = 3,

    /// <summary>
    /// EN: Signal - 思考パターン（attention の優先対象）
    /// EN: Documentation for public API. JA: ReasoningPatternPriority 値を表します。
    /// </summary>
    ReasoningPatternPriority = 4,

    /// <summary>
    /// EN: Noise - 表面的な特徴（attention から隔離すべき）
    /// EN: Documentation for public API. JA: ExampleNoise 値を表します。
    /// </summary>
    ExampleNoise = 101,

    /// <summary>
    /// EN: Noise - 文体指示（attention から隔離すべき）
    /// EN: Documentation for public API. JA: StyleNoise 値を表します。
    /// </summary>
    StyleNoise = 102,

    /// <summary>
    /// EN: Noise - RAG の断片（attention から隔離すべき）
    /// EN: Documentation for public API. JA: RagFragmentNoise 値を表します。
    /// </summary>
    RagFragmentNoise = 103,

    /// <summary>
    /// EN: Noise - 履歴の混入（attention から隔離すべき）
    /// EN: Documentation for public API. JA: HistoryNoise 値を表します。
    /// </summary>
    HistoryNoise = 104,

    /// <summary>
    /// EN: Noise - その他ノイズ（attention から隔離すべき）
    /// EN: Documentation for public API. JA: GeneralNoise 値を表します。
    /// </summary>
    GeneralNoise = 105
}
