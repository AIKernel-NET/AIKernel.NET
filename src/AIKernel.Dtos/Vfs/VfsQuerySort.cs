...
/// [EN] Documents this public package API member. [JA] VfsQuerySort の公開契約を定義します。
/// </summary>
...
{
    /// <summary>[EN] Documents this public package API member. [JA] FieldName を取得します。</summary>
    ...
    /// <summary>[EN] Documents this public package API member. [JA] Ascending を取得します。</summary>
