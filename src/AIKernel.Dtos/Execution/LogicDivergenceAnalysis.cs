...
/// [EN] Documents this public package API member. [JA] LogicDivergenceAnalysis の公開契約を定義します。
/// </summary>
...
{
    /// <summary>[EN] Documents this public package API member. [JA] DivergenceDetected を取得します。</summary>
    ...
    /// <summary>[EN] Documents this public package API member. [JA] DivergenceType を取得します。</summary>
    ...
    /// <summary>[EN] Documents this public package API member. [JA] Severity を取得します。</summary>
    ...
    /// <summary>[EN] Documents this public package API member. [JA] AlteredSegments を実行します。</summary>
