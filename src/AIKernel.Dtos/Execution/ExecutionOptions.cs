...
/// <summary>EN: Documentation for public API. JA: ExecutionOptions を表します。</summary>
...
{
    /// <summary>EN: Documentation for public API. JA: Temperature を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: TopP を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: StopSequences を取得します。</summary>
