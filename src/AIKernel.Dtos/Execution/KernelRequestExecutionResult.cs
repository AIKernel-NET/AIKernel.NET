...
/// <summary>EN: Documentation for public API. JA: KernelRequestExecutionResult を表します。</summary>
...
{
    /// <summary>EN: Documentation for public API. JA: ExecutionId を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: PromptHash を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: OutputText を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: Usage を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: StartedAtUtc を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: CompletedAtUtc を取得します。</summary>
