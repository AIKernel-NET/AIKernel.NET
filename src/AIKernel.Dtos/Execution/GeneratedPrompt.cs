...
/// <summary>EN: Documentation for public API. JA: GeneratedPrompt を表します。</summary>
...
{
    /// <summary>EN: Documentation for public API. JA: PromptId を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: Capability を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: Messages を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: EstimatedInputTokens を取得します。</summary>
