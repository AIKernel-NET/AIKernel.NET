...
/// [EN] Documents this public package API member. [JA] ModificationContext の公開契約を定義します。
/// </summary>
...
public sealed record ModificationContext
{
    ...
    /// <summary>[EN] Documents this public package API member. [JA] TargetPhase を取得します。</summary>
    ...
    /// <summary>[EN] Documents this public package API member. [JA] ModificationData を取得します。</summary>
    ...
    /// <summary>[EN] Documents this public package API member. [JA] ModifiedBy を取得します。</summary>
