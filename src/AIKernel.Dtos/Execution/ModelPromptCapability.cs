...
/// <summary>EN: Documentation for public API. JA: ModelPromptCapability を表します。</summary>
...
public sealed record ModelPromptCapability
{
    ...
    /// <summary>EN: Documentation for public API. JA: MessageFormat を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: MaxOutputTokens を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: SupportsSystemMessages を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: SupportsDeveloperMessages を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: RequiresAlternatingUserAssistantMessages を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: SystemInstructionRole を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: SupportedRoles を取得します。</summary>
