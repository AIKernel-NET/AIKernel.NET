...
/// <summary>
/// EN: Provider budget envelope used by the computational complexity admission gate.
/// [EN] Documents this public package API member. [JA] ModelExecutionBudget の公開契約を定義します。
/// </summary>
