...
/// [EN] Documents this public package API member. [JA] PermissionConstraint の公開契約を定義します。
/// </summary>
...
{
    /// <summary>[EN] Documents this public package API member. [JA] ConstraintType を取得します。</summary>
