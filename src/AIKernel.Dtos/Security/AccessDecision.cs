...
/// EN: Documentation for public API. JA: AccessDecision の公開契約を定義します。
/// </summary>
...
{
    /// <summary>EN: Documentation for public API. JA: Allowed を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: AppliedPolicies を実行します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: Constraints を取得します。</summary>
