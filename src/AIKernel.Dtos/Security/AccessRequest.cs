...
/// EN: Documentation for public API. JA: AccessRequest の公開契約を定義します。
/// </summary>
...
{
    /// <summary>EN: Documentation for public API. JA: Principal を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: Action を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: Resource を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: Environment を取得します。</summary>
