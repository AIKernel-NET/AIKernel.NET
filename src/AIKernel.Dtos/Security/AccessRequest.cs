...
/// <summary>
/// EN: AccessRequest の契約を定義します。
/// [EN] Documents this public package API member. [JA] AccessRequest の公開契約を定義します。
/// </summary>
...
{
    /// <summary>[EN] Documents this public package API member. [JA] Principal を取得します。</summary>
    ...
    /// <summary>[EN] Documents this public package API member. [JA] Action を取得します。</summary>
    ...
    /// <summary>[EN] Documents this public package API member. [JA] Resource を取得します。</summary>
    ...
    /// <summary>[EN] Documents this public package API member. [JA] Environment を取得します。</summary>
