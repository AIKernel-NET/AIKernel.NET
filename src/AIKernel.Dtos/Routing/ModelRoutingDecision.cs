...
/// EN: Documentation for public API. JA: ModelRoutingDecision の公開契約を定義します。
/// </summary>
...
{
    /// <summary>EN: Documentation for public API. JA: SelectedProviderId を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: SelectionRationale を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: EffectiveCapacity を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: FittingScore を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: DecisionTimestamp を取得します。</summary>
