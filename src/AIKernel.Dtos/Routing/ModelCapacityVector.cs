...
/// [EN] Documents this public package API member. [JA] ModelCapacityVector の公開契約を定義します。
/// </summary>
...
{
    /// <summary>[EN] Documents this public package API member. [JA] StructuralIntegrity を取得します。</summary>
    ...
    /// <summary>[EN] Documents this public package API member. [JA] LinguisticFluidity を取得します。</summary>
    ...
    /// <summary>[EN] Documents this public package API member. [JA] ReasoningDepth を取得します。</summary>
    ...
    /// <summary>[EN] Documents this public package API member. [JA] Fidelity を取得します。</summary>
    ...
    /// <summary>[EN] Documents this public package API member. [JA] LatencyPerformance を取得します。</summary>
    ...
    /// <summary>[EN] Documents this public package API member. [JA] ModelCapacityVector を取得します。</summary>
