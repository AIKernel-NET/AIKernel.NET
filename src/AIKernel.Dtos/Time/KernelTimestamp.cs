...
/// [EN] Documents this public package API member. [JA] KernelTimestamp の公開契約を定義します。
/// </summary>
...
{
    /// <summary>[EN] Documents this public package API member. [JA] UtcDateTime を取得します。</summary>
    ...
    /// <summary>[EN] Documents this public package API member. [JA] LogicalCounter を取得します。</summary>
    ...
    /// <summary>[EN] Documents this public package API member. [JA] SourceId を取得します。</summary>
