...
/// <summary>
/// EN: CanonicalizedRomDocument の契約を定義します。
/// [EN] Documents this public package API member. [JA] CanonicalizedRomDocument の公開契約を定義します。
/// </summary>
...
{
    /// <summary>[EN] Documents this public package API member. [JA] NormalizedEntityId を取得します。</summary>
    ...
    /// <summary>[EN] Documents this public package API member. [JA] NormalizedMetadata を取得します。</summary>
    ...
    /// <summary>[EN] Documents this public package API member. [JA] NormalizedBody を取得します。</summary>
    ...
    /// <summary>[EN] Documents this public package API member. [JA] ResolvedRelations を実行します。</summary>
    ...
    /// <summary>[EN] Documents this public package API member. [JA] CanonicalizedAt を取得します。</summary>
