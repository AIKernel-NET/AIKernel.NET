...
/// EN: Documentation for public API. JA: CanonicalizedRomDocument の公開契約を定義します。
/// </summary>
...
{
    /// <summary>EN: Documentation for public API. JA: NormalizedEntityId を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: NormalizedMetadata を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: NormalizedBody を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: ResolvedRelations を実行します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: CanonicalizedAt を取得します。</summary>
