...
/// <summary>[EN] Documents this public package API member. [JA] RomSnapshot を表します。</summary>
...
public sealed record RomSnapshot
{
    ...
    /// <summary>[EN] Documents this public package API member. [JA] LoadedAtUtc を取得します。</summary>
