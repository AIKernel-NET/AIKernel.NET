...
/// EN: Documentation for public API. JA: EntityTypeSchema の公開契約を定義します。
/// </summary>
...
{
    /// <summary>EN: Documentation for public API. JA: TypeName を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: RequiredProperties を実行します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: PropertyTypes を実行します。</summary>
