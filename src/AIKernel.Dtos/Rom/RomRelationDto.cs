...
/// [EN] Documents this public package API member. [JA] RomRelationDto の公開契約を定義します。
/// </summary>
...
public sealed record RomRelationDto
{
    ...
    /// <summary>[EN] Documents this public package API member. [JA] RelationName を取得します。</summary>
    ...
    /// <summary>[EN] Documents this public package API member. [JA] TargetReference を取得します。</summary>
    ...
    /// <summary>[EN] Documents this public package API member. [JA] NumericValue を取得します。</summary>
    ...
    /// <summary>[EN] Documents this public package API member. [JA] TextValue を取得します。</summary>
