...
/// [EN] Documents this public package API member. [JA] ResolvedRomRelationDto の公開契約を定義します。
/// </summary>
...
public sealed record ResolvedRomRelationDto
{
    ...
    /// <summary>[EN] Documents this public package API member. [JA] FullyQualifiedId を取得します。</summary>
