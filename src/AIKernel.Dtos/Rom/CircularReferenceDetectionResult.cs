...
/// EN: Documentation for public API. JA: CircularReferenceDetectionResult の公開契約を定義します。
/// </summary>
...
{
    /// <summary>EN: Documentation for public API. JA: CircularReferencesDetected を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: CircularChains を実行します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: MayTriggerInferenceLoop を取得します。</summary>
