...
/// [EN] Documents this public package API member. [JA] RomLinkageValidationResult の公開契約を定義します。
/// </summary>
...
{
    /// <summary>[EN] Documents this public package API member. [JA] AllLinksResolvable を取得します。</summary>
    ...
    /// <summary>[EN] Documents this public package API member. [JA] UnresolvedLinks を実行します。</summary>
