...
/// <summary>[EN] Documents this public package API member. [JA] HistoryRomMetadata を表します。</summary>
...
/// <summary>[EN] Documents this public package API member. [JA] HistoryRomMetadataKeys を表します。</summary>
...
public static class HistoryRomMetadataKeys
{
    ...
    /// <summary>[EN] Documents this public package API member. [JA] RomId 定数を取得します。</summary>
