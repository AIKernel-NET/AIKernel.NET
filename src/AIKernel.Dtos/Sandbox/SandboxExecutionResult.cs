...
/// EN: Documentation for public API. JA: SandboxExecutionResult の公開契約を定義します。
/// </summary>
...
public sealed class SandboxExecutionResult
{
    ...
    /// <summary>EN: Documentation for public API. JA: Result を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: ErrorMessage を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: ExecutionTimeMs を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: StdOut を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: StdErr を取得します。</summary>
