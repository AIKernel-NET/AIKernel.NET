...
/// [EN] Documents this public package API member. [JA] SandboxResourceUsage の公開契約を定義します。
/// </summary>
...
{
    /// <summary>[EN] Documents this public package API member. [JA] CpuUsagePercent を取得します。</summary>
    ...
    /// <summary>[EN] Documents this public package API member. [JA] MemoryUsageMb を取得します。</summary>
    ...
    /// <summary>[EN] Documents this public package API member. [JA] MemoryLimitMb を取得します。</summary>
    ...
    /// <summary>[EN] Documents this public package API member. [JA] DiskUsageMb を取得します。</summary>
    ...
    /// <summary>[EN] Documents this public package API member. [JA] DiskLimitMb を取得します。</summary>
