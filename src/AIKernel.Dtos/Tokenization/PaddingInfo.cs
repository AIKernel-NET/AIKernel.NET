...
/// EN: Documentation for public API. JA: PaddingInfo の公開契約を定義します。
/// </summary>
...
{
    /// <summary>EN: Documentation for public API. JA: LogicalTokenCount を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: PhysicalCardinality を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: PaddingAmount を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: PaddingPercentage を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: PaddingMethod を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: MemoryDifferenceBytes を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: Rationale を取得します。</summary>
