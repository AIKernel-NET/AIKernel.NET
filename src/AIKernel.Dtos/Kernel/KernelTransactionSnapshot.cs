...
/// <summary>EN: Documentation for public API. JA: KernelTransactionSnapshot を表します。</summary>
...
{
    /// <summary>EN: Documentation for public API. JA: TransactionId を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: InputHash を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: RootRomId を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: VfsProviderId を取得します。</summary>
