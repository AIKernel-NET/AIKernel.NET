...
/// EN: Documentation for public API. JA: AttentionAnalysis の公開契約を定義します。
/// </summary>
...
{
    /// <summary>EN: Documentation for public API. JA: SignalToNoiseRatio を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: DetectedPollution を実行します。</summary>
