...
/// <summary>[EN] Documents this public package API member. [JA] OrchestrationBuffer を表します。</summary>
...
public readonly struct OrchestrationBuffer
{
    ...
    /// <summary>[EN] Documents this public package API member. [JA] OrchestrationBuffer を実行します。</summary>
