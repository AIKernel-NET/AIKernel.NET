...
/// EN: Documentation for public API. JA: ContextFragment の公開契約を定義します。
/// </summary>
...
{
    /// <summary>EN: Documentation for public API. JA: FragmentId を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: Category を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: Content を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: Priority を取得します。</summary>
