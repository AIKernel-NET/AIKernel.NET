...
/// <summary>EN: Documentation for public API. JA: ContextAssemblyRequest を表します。</summary>
...
{
    /// <summary>EN: Documentation for public API. JA: MaxDepth を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: RelationKindsToFollow を取得します。</summary>
