...
/// <summary>[EN] Documents this public package API member. [JA] MaterialBuffer を表します。</summary>
...
public readonly struct MaterialBuffer
{
    ...
    /// <summary>[EN] Documents this public package API member. [JA] MaterialBuffer を実行します。</summary>
