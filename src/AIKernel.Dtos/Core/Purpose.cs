...
/// 目的を表現します。
/// EN: 処理の意図と目標を定義します。
/// EN: Documentation for public API. JA: Purpose の公開契約を定義します。
/// </summary>
...
{
    /// <summary>EN: Documentation for public API. JA: PurposeId を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: Tags を実行します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: SuccessCriteria を取得します。</summary>
