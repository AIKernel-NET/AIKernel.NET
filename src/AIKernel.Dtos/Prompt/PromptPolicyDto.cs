...
/// EN: Documentation for public API. JA: PromptPolicyDto の公開契約を定義します。
/// </summary>
...
{
    /// <summary>EN: Documentation for public API. JA: TrustLevelRequired を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: AllowedProviders を実行します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: MaxTokenBudget を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: ExpiresAt を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: PromptPolicyDto を実行します。</summary>
