...
/// EN: Documentation for public API. JA: QueryPart の公開契約を定義します。
/// </summary>
...
public sealed record QueryPart
{
    ...
    /// EN: Documentation for public API. JA: QueryPartId を取得します。
    /// </summary>
    ...
    /// EN: Documentation for public API. JA: Text を取得します。
    /// </summary>
    ...
    /// EN: Documentation for public API. JA: Order を取得します。
    /// </summary>
    ...
    /// EN: Documentation for public API. JA: ParentQueryId を取得します。
    /// </summary>
    ...
    /// EN: Documentation for public API. JA: Role を取得します。
    /// </summary>
