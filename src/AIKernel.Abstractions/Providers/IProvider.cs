...
/// EN: Documentation for public API. JA: IProviderIdentity の公開契約を定義します。
/// </summary>
...
public interface IProviderIdentity
{
    ...
    /// EN: Documentation for public API. JA: IProviderCapabilitySource の公開契約を定義します。
    /// </summary>
    string Version { get; }
}
...
public interface IProviderCapabilitySource
{
    ...
    /// EN: Documentation for public API. JA: GetCapabilities 操作を実行します。
    /// </summary>
...
/// EN: Documentation for public API. JA: IProviderAvailabilityProbe の公開契約を定義します。
/// </summary>
...
/// EN: Documentation for public API. JA: IProviderLifecycle の公開契約を定義します。
/// </summary>
...
public interface IProviderLifecycle
{
    ...
    /// <summary>
    /// EN: プロバイダーを終了します。
    /// EN: Documentation for public API. JA: ShutdownAsync 操作を実行します。
    /// </summary>
    Task ShutdownAsync();
}
...
/// EN: Documentation for public API. JA: IProviderHealthProbe の公開契約を定義します。
/// </summary>
...
/// EN: Documentation for public API. JA: IProvider の公開契約を定義します。
/// </summary>
