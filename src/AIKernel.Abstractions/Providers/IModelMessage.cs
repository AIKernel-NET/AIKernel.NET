...
{
    /// <summary>Gets the Role value exposed by the AIKernel public contract surface. JA: AIKernel の公開契約サーフェスで公開される Role 値を取得します。</summary>
    string Role { get; }
