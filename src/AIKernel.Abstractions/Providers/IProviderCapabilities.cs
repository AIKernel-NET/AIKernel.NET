...
/// JA: IProviderOperationCapabilities の公開契約を定義します。
/// </summary>
...
public interface IProviderOperationCapabilities
{
    ...
    /// JA: SupportsOperation 操作を実行します。
    /// </summary>
    /// <param name="operation">操作名 JA: operation パラメーターです。</param>
    /// <returns>サポートしている場合は true JA: 結果を返します。</returns>
    bool SupportsOperation(string operation);

    /// <summary>
    /// 特定のデータタイプをサポートしているかどうかを確認します。
    /// JA: SupportsDataType 操作を実行します。
    /// </summary>
    /// <param name="dataType">データタイプ JA: dataType パラメーターです。</param>
    /// <returns>サポートしている場合は true JA: 結果を返します。</returns>
...
/// JA: IProviderConnectionCapabilities の公開契約を定義します。
/// </summary>
...
public interface IProviderConnectionCapabilities
{
    ...
    /// <summary>
    /// レート制限情報を取得します。
    /// JA: IProviderCapacityVectorSource の公開契約を定義します。
    /// </summary>
...
public interface IProviderCapacityVectorSource
{
    ...
    /// 静的な環境での能力を表します。
    /// JA: IDynamicProviderCapacitySource の公開契約を定義します。
    /// </summary>
...
public interface IDynamicProviderCapacitySource
{
    ...
    /// JA: GetDynamicCapacities 操作を実行します。
    /// </summary>
    /// <param name="constraints">実行制約条件 JA: constraints パラメーターです。</param>
    /// <returns>制約下での動的能力ベクトル JA: 結果を返します。</returns>
...
/// JA: IProviderProfileSource の公開契約を定義します。
/// </summary>
...
public interface IProviderProfileSource
{
    ...
    /// </summary>
    /// <returns>能力プロファイル、有効でない場合は null JA: 結果を返します。</returns>
...
/// UC-05/UC-19/UC-23/UC-26/UC-27 に基づく契約です。
/// 量子化サポート情報を公開します。
/// JA: IQuantizationSupport の公開契約を定義します。
/// </summary>
...
public interface IQuantizationSupport
{
    ...
    /// JA: SupportsQuantization 操作を実行します。
    /// </summary>
    /// <param name="quantizationLevel">量子化レベル（例："INT8", "FP16", "FP32"） JA: quantizationLevel パラメーターです。</param>
    /// <returns>サポートしている場合は true JA: 結果を返します。</returns>
...
/// JA: IQueryProcessingCapabilities の公開契約を定義します。
/// </summary>
...
public interface IQueryProcessingCapabilities
{
    ...
    /// JA: SupportsQueryProcessingOperation 操作を実行します。
    /// </summary>
...
/// JA: IEmbeddingCapabilityMetadata の公開契約を定義します。
/// </summary>
...
public interface IEmbeddingCapabilityMetadata
{
    ...
    /// JA: IProviderCapabilities の公開契約を定義します。
    /// </summary>
