...
/// [EN] Documents this public package API member. [JA] IProviderOperationCapabilities の公開契約を定義します。
/// </summary>
...
public interface IProviderOperationCapabilities
{
    ...
    /// [EN] Documents this public package API member. [JA] SupportsOperation 操作を実行します。
    /// </summary>
    ...
    /// [EN] Documents this public package API member. [JA] SupportsOperation 操作を実行します。
    /// </summary>
    /// <param name="operation">[EN] Documents this public package API member. [JA] 操作名 operation パラメーターです。</param>
    ...
    /// [EN] Documents this public package API member. [JA] SupportsDataType 操作を実行します。
    /// </summary>
    /// <param name="dataType">[EN] Documents this public package API member. [JA] データタイプ dataType パラメーターです。</param>
    /// <returns>[EN] Documents this public package API member. [JA] サポートしている場合は true 結果を返します。</returns>
...
/// [EN] Documents this public package API member. [JA] IProviderConnectionCapabilities の公開契約を定義します。
/// </summary>
...
public interface IProviderConnectionCapabilities
{
    ...
    /// <summary>
    /// EN: レート制限情報を取得します。
    /// [EN] Documents this public package API member. [JA] IProviderCapacityVectorSource の公開契約を定義します。
    /// </summary>
...
public interface IProviderCapacityVectorSource
{
    ...
    /// EN: 静的な環境での能力を表します。
    /// [EN] Documents this public package API member. [JA] IDynamicProviderCapacitySource の公開契約を定義します。
    /// </summary>
...
public interface IDynamicProviderCapacitySource
{
    ...
    /// [EN] Documents this public package API member. [JA] GetDynamicCapacities 操作を実行します。
    /// </summary>
    /// <param name="constraints">[EN] Documents this public package API member. [JA] 実行制約条件 constraints パラメーターです。</param>
    /// <returns>[EN] Documents this public package API member. [JA] 制約下での動的能力ベクトル 結果を返します。</returns>
...
/// [EN] Documents this public package API member. [JA] IProviderProfileSource の公開契約を定義します。
/// </summary>
...
public interface IProviderProfileSource
{
    ...
    /// </summary>
    /// <returns>[EN] Documents this public package API member. [JA] 能力プロファイル、有効でない場合は null 結果を返します。</returns>
...
/// UC-05/UC-19/UC-23/UC-26/UC-27 に基づく契約です。
/// EN: 量子化サポート情報を公開します。
/// [EN] Documents this public package API member. [JA] IQuantizationSupport の公開契約を定義します。
/// </summary>
...
public interface IQuantizationSupport
{
    ...
    /// [EN] Documents this public package API member. [JA] SupportsQuantization 操作を実行します。
    /// </summary>
    /// <param name="quantizationLevel">[EN] Documents this public package API member. [JA] 量子化レベル（例："INT8", "FP16", "FP32"） quantizationLevel パラメーターです。</param>
    /// <returns>[EN] Documents this public package API member. [JA] サポートしている場合は true 結果を返します。</returns>
...
/// [EN] Documents this public package API member. [JA] IQueryProcessingCapabilities の公開契約を定義します。
/// </summary>
...
public interface IQueryProcessingCapabilities
{
    ...
    /// [EN] Documents this public package API member. [JA] SupportsQueryProcessingOperation 操作を実行します。
    /// </summary>
...
/// [EN] Documents this public package API member. [JA] IEmbeddingCapabilityMetadata の公開契約を定義します。
/// </summary>
...
public interface IEmbeddingCapabilityMetadata
{
    ...
    /// [EN] Documents this public package API member. [JA] IProviderCapabilities の公開契約を定義します。
    /// </summary>
