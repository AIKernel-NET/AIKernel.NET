...
/// [EN] Documents this public package API member. [JA] ITelemetryProvider の公開契約を定義します。
/// </summary>
public interface ITelemetryProvider
{
    ...
    /// [EN] Documents this public package API member. [JA] StreamAsync 操作を実行します。
    /// </summary>
    ...
    /// [EN] Documents this public package API member. [JA] ResetTelemetryAsync 操作を実行します。
    /// </summary>
