...
/// EN: Documentation for public API. JA: IRuntimeTelemetryProvider の公開契約を定義します。
/// </summary>
public interface IRuntimeTelemetryProvider : IKernelProvider
{
    /// <summary>
    /// EN: Captures a runtime telemetry snapshot.
    /// EN: Documentation for public API. JA: CaptureTelemetryAsync 操作を実行します。
    /// </summary>
...
/// EN: Documentation for public API. JA: IEvidenceCaptureProvider の公開契約を定義します。
/// </summary>
...
/// EN: Documentation for public API. JA: IReplayEvidenceProvider の公開契約を定義します。
/// </summary>
public interface IReplayEvidenceProvider : IKernelProvider
{
    /// <summary>
    /// EN: Records replay evidence.
    /// EN: Documentation for public API. JA: RecordAsync 操作を実行します。
    /// </summary>
