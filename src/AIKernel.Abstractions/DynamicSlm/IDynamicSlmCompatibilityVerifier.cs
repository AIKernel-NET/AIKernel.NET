...
{
    /// <summary>Executes the VerifyCompatibilityAsync operation on the AIKernel public contract surface. JA: AIKernel の公開契約サーフェスで VerifyCompatibilityAsync 操作を実行します。</summary>
