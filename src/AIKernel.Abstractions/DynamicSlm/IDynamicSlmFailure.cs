...
{
    /// <summary>Gets the Kind value exposed by the AIKernel public contract surface. JA: AIKernel の公開契約サーフェスで公開される Kind 値を取得します。</summary>
    ...
    /// <summary>Gets the Code value exposed by the AIKernel public contract surface. JA: AIKernel の公開契約サーフェスで公開される Code 値を取得します。</summary>
    string Code { get; }

    /// <summary>Gets the Message value exposed by the AIKernel public contract surface. JA: AIKernel の公開契約サーフェスで公開される Message 値を取得します。</summary>
    string Message { get; }

    /// <summary>Gets the ReplayLogHash value exposed by the AIKernel public contract surface. JA: AIKernel の公開契約サーフェスで公開される ReplayLogHash 値を取得します。</summary>
