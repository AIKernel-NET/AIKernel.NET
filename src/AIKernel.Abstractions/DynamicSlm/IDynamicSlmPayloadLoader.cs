...
{
    /// <summary>Executes the MaterializeAsync operation on the AIKernel public contract surface. JA: AIKernel の公開契約サーフェスで MaterializeAsync 操作を実行します。</summary>
    ...
    /// <summary>Executes the UnloadAsync operation on the AIKernel public contract surface. JA: AIKernel の公開契約サーフェスで UnloadAsync 操作を実行します。</summary>
