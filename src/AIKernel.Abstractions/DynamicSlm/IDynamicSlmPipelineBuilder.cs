...
/// <summary>[EN] Documents this public package API member. [JA] IDynamicSlmPipelineBuilder contract を定義します。</summary>
...
{
    /// <summary>EN: Executes the AddStep&lt;TInput, TOutput&gt; operation on the AIKernel public contract surface. JA: AIKernel の公開契約サーフェスで AddStep&lt;TInput, TOutput&gt; 操作を実行します。</summary>
    IDynamicSlmPipelineBuilder AddStep<TInput, TOutput>(
        IDynamicSlmAsyncPipelineStep<TInput, TOutput> step);

    /// <summary>EN: Executes the Build operation on the AIKernel public contract surface. JA: AIKernel の公開契約サーフェスで Build 操作を実行します。</summary>
