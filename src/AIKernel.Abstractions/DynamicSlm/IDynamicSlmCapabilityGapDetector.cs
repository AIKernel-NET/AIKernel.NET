...
/// <summary>[EN] Documents this public package API member. [JA] IDynamicSlmCapabilityGapDetector contract を定義します。</summary>
...
{
    /// <summary>EN: Executes the DetectGapsAsync operation on the AIKernel public contract surface. JA: AIKernel の公開契約サーフェスで DetectGapsAsync 操作を実行します。</summary>
