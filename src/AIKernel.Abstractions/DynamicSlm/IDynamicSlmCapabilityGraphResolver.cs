...
{
    /// <summary>Executes the ResolveSubgraphAsync operation on the AIKernel public contract surface. JA: AIKernel の公開契約サーフェスで ResolveSubgraphAsync 操作を実行します。</summary>
