...
/// [EN] Documents this public package API member. [JA] IEventPublisher の公開契約を定義します。
/// </summary>
...
public interface IEventPublisher
{
    /// <summary>
    /// EN: イベントを発行します。
    /// [EN] Documents this public package API member. [JA] PublishAsync 操作を実行します。
    /// </summary>
    /// <param name="eventName">[EN] Documents this public package API member. [JA] イベント名 eventName パラメーターです。</param>
    /// <param name="eventData">[EN] Documents this public package API member. [JA] イベントデータ eventData パラメーターです。</param>
...
/// [EN] Documents this public package API member. [JA] IEventBroadcaster の公開契約を定義します。
/// </summary>
...
public interface IEventBroadcaster
{
    ...
    /// [EN] Documents this public package API member. [JA] BroadcastAsync 操作を実行します。
    /// </summary>
    /// <param name="eventName">[EN] Documents this public package API member. [JA] イベント名 eventName パラメーターです。</param>
    /// <param name="eventData">[EN] Documents this public package API member. [JA] イベントデータ eventData パラメーターです。</param>
    /// <param name="cancellationToken">[EN] Documents this public package API member. [JA] キャンセルトークン キャンセル通知を監視するトークンです。</param>
...
/// [EN] Documents this public package API member. [JA] IEventSubscriptionRegistry の公開契約を定義します。
/// </summary>
...
public interface IEventSubscriptionRegistry
{
    /// <summary>
    /// EN: イベントに購読します。
    /// [EN] Documents this public package API member. [JA] Unsubscribe 操作を実行します。
    /// </summary>
    /// <typeparam name="T">[EN] Documents this public package API member. [JA] イベントデータの型 T 型パラメーターです。</typeparam>
    /// <param name="eventName">[EN] Documents this public package API member. [JA] イベント名 eventName パラメーターです。</param>
    /// <param name="handler">[EN] Documents this public package API member. [JA] イベントハンドラー handler パラメーターです。</param>
    /// <returns>[EN] Documents this public package API member. [JA] 購読ID（購読解除時に使用） 結果を返します。</returns>
    ...
    /// [EN] Documents this public package API member. [JA] Unsubscribe 操作を実行します。
    /// </summary>
    /// <param name="subscriptionId">[EN] Documents this public package API member. [JA] 購読ID subscriptionId パラメーターです。</param>
    /// <returns>[EN] Documents this public package API member. [JA] 解除成功の可否 結果を返します。</returns>
    bool Unsubscribe(string subscriptionId);

    /// <summary>
    /// EN: 指定されたイベント名の購読者数を取得します。
    /// [EN] Documents this public package API member. [JA] GetSubscriberCount 操作を実行します。
    /// </summary>
    /// <param name="eventName">[EN] Documents this public package API member. [JA] イベント名 eventName パラメーターです。</param>
    /// <returns>[EN] Documents this public package API member. [JA] 購読者数 結果を返します。</returns>
...
/// [EN] Documents this public package API member. [JA] IEventBus の公開契約を定義します。
/// </summary>
