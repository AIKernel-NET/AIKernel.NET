...
/// [EN] Documents this public package API member. [JA] ISignerTrustResolver の公開契約を定義します。
/// </summary>
...
public interface ISignerTrustResolver
{
    ...
    /// [EN] Documents this public package API member. [JA] ResolveTrustScoreAsync 操作を実行します。
    /// </summary>
    /// <param name="signerId">[EN] Documents this public package API member. [JA] 署名者 ID signerId パラメーターです。</param>
    /// <param name="cancellationToken">[EN] Documents this public package API member. [JA] キャンセルトークン キャンセル通知を監視するトークンです。</param>
    /// <returns>[EN] Documents this public package API member. [JA] 信頼スコア（0.0-1.0）。0 未満はエラー/不信。1.0 は完全信頼。 結果を返します。</returns>
    /// <remarks>
...
/// [EN] Documents this public package API member. [JA] IKeyRevocationChecker の公開契約を定義します。
/// </summary>
...
public interface IKeyRevocationChecker
{
    ...
    /// EN: SGS-006 の実装。
    /// [EN] Documents this public package API member. [JA] IsKeyRevokedAsync 操作を実行します。
    /// </summary>
    /// <param name="keyId">[EN] Documents this public package API member. [JA] 鍵 ID keyId パラメーターです。</param>
    /// <param name="cancellationToken">[EN] Documents this public package API member. [JA] キャンセルトークン キャンセル通知を監視するトークンです。</param>
    /// <returns>[EN] Documents this public package API member. [JA] 失効している場合は true 結果を返します。</returns>
...
/// [EN] Documents this public package API member. [JA] IKeyExpiryReader の公開契約を定義します。
/// </summary>
...
public interface IKeyExpiryReader
{
    ...
    /// [EN] Documents this public package API member. [JA] GetKeyExpiryAsync 操作を実行します。
    /// </summary>
    /// <param name="keyId">[EN] Documents this public package API member. [JA] 鍵 ID keyId パラメーターです。</param>
    /// <param name="cancellationToken">[EN] Documents this public package API member. [JA] キャンセルトークン キャンセル通知を監視するトークンです。</param>
    /// <returns>[EN] Documents this public package API member. [JA] 有効期限（UTC）、失効していない場合のみ返される 結果を返します。</returns>
...
/// [EN] Documents this public package API member. [JA] ICertificateChainVerifier の公開契約を定義します。
/// </summary>
...
public interface ICertificateChainVerifier
{
    ...
    /// 署名者の証明書チェーンを検証します。
    /// EN: SGS-006: 信頼連鎖の検証。
    /// [EN] Documents this public package API member. [JA] VerifyCertificateChainAsync 操作を実行します。
    /// </summary>
    /// <param name="signerId">[EN] Documents this public package API member. [JA] 署名者 ID signerId パラメーターです。</param>
    /// <param name="cancellationToken">[EN] Documents this public package API member. [JA] キャンセルトークン キャンセル通知を監視するトークンです。</param>
    /// <returns>[EN] Documents this public package API member. [JA] 証明書チェーンが有効かどうか 結果を返します。</returns>
...
/// [EN] Documents this public package API member. [JA] ITrustedAnchorReader の公開契約を定義します。
/// </summary>
...
public interface ITrustedAnchorReader
{
    ...
    /// [EN] Documents this public package API member. [JA] GetTrustedAnchorsAsync 操作を実行します。
    /// </summary>
    /// <param name="cancellationToken">[EN] Documents this public package API member. [JA] キャンセルトークン キャンセル通知を監視するトークンです。</param>
    /// <returns>[EN] Documents this public package API member. [JA] 信頼できるルートキー/認証局の ID リスト 結果を返します。</returns>
...
/// [EN] Documents this public package API member. [JA] ITrustStoreHealthProbe の公開契約を定義します。
/// </summary>
...
public interface ITrustStoreHealthProbe
{
    ...
    /// [EN] Documents this public package API member. [JA] IsHealthyAsync 操作を実行します。
    /// </summary>
    /// <param name="cancellationToken">[EN] Documents this public package API member. [JA] キャンセルトークン キャンセル通知を監視するトークンです。</param>
    /// <returns>[EN] Documents this public package API member. [JA] ストアが到達可能でかつ正常に動作しているかどうか 結果を返します。</returns>
...
/// [EN] Documents this public package API member. [JA] ISignatureTrustStore の公開契約を定義します。
/// </summary>
