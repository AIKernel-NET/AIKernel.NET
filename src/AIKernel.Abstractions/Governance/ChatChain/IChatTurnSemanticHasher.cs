...
/// <summary>
/// EN: Computes the deterministic hash for a chat turn from canonical content and the previous turn hash.
/// [EN] Documents this public package API member. [JA] IChatTurnSemanticHasher の公開契約を定義します。
/// </summary>
