...
public interface ITask
{
    ...
    /// <summary>Gets the TaskType value exposed by the AIKernel public contract surface. JA: AIKernel の公開契約サーフェスで公開される TaskType 値を取得します。</summary>
    ...
    /// <summary>Executes the GetInputSchema operation on the AIKernel public contract surface. JA: AIKernel の公開契約サーフェスで GetInputSchema 操作を実行します。</summary>
    IReadOnlyDictionary<string, string>? GetInputSchema();
    /// <summary>Executes the GetOutputSchema operation on the AIKernel public contract surface. JA: AIKernel の公開契約サーフェスで GetOutputSchema 操作を実行します。</summary>
    IReadOnlyDictionary<string, string>? GetOutputSchema();
    /// <summary>Executes the CanExecute operation on the AIKernel public contract surface. JA: AIKernel の公開契約サーフェスで CanExecute 操作を実行します。</summary>
