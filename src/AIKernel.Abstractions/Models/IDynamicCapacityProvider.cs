...
/// EN: Documentation for public API. JA: IDynamicCapacityProvider の公開契約を定義します。
/// </summary>
...
public interface IDynamicCapacityProvider
{
    ...
    /// EN: Documentation for public API. JA: ResolveCapacity 操作を実行します。
    /// </summary>
    /// <param name="constraints">EN: Documentation for public API. JA: 実行制約条件 constraints パラメーターです。</param>
    /// <returns>EN: Documentation for public API. JA: 制約下での能力ベクトル（Dictionary形式） 結果を返します。</returns>
    IDictionary<string, float> ResolveCapacity(IExecutionConstraints constraints);

    /// <summary>
    /// EN: 複数のモデル候補から、指定された制約下で最適なモデルを選定します。
    /// EN: Documentation for public API. JA: SelectOptimalModelForConstraints 操作を実行します。
    /// </summary>
    /// <param name="candidates">EN: Documentation for public API. JA: 候補モデルタイプのリスト candidates パラメーターです。</param>
    /// <param name="constraints">EN: Documentation for public API. JA: 実行制約条件 constraints パラメーターです。</param>
    /// <param name="requirement">EN: Documentation for public API. JA: 要求される能力ベクトル requirement パラメーターです。</param>
    /// <returns>EN: Documentation for public API. JA: 最適なモデルタイプ 結果を返します。</returns>
    ...
    /// EN: Documentation for public API. JA: RegisterCapabilityProfile 操作を実行します。
    /// </summary>
    /// <param name="modelType">EN: Documentation for public API. JA: モデルタイプ modelType パラメーターです。</param>
    /// <param name="profile">EN: Documentation for public API. JA: 能力プロファイル profile パラメーターです。</param>
    ...
    /// </summary>
    /// <param name="modelType">EN: Documentation for public API. JA: モデルタイプ modelType パラメーターです。</param>
    /// <returns>EN: Documentation for public API. JA: 能力プロファイル 結果を返します。</returns>
    ICapabilityProfile GetCapabilityProfile(ModelType modelType);

    /// <summary>
    /// EN: 実行可能なすべてのモデルタイプを取得します。
    /// EN: Documentation for public API. JA: GetRegisteredModels 操作を実行します。
    /// </summary>
    /// <returns>EN: Documentation for public API. JA: 登録済みモデルタイプの列挙 結果を返します。</returns>
