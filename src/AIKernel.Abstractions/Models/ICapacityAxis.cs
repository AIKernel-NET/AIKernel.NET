...
/// [EN] Documents this public package API member. [JA] ICapacityAxis の公開契約を定義します。
/// </summary>
...
public interface ICapacityAxis
{
    ...
    /// [EN] Documents this public package API member. [JA] IsValueValid 操作を実行します。
    /// </summary>
    ...
    /// [EN] Documents this public package API member. [JA] IsValueValid 操作を実行します。
    /// </summary>
    /// <param name="value">[EN] Documents this public package API member. [JA] チェックする値 value パラメーターです。</param>
    /// <returns>[EN] Documents this public package API member. [JA] 値が有効な範囲内の場合は true 結果を返します。</returns>
