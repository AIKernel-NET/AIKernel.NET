...
/// EN: 実行環境制約を統合して表現します。
/// [EN] Documents this public package API member. [JA] IExecutionConstraints の公開契約を定義します。
/// </summary>
...
public interface IExecutionConstraints
{
    ...
    /// [EN] Documents this public package API member. [JA] GetContextValue 操作を実行します。
    /// </summary>
    ...
    /// [EN] Documents this public package API member. [JA] GetContextValue 操作を実行します。
    /// </summary>
    /// <param name="key">[EN] Documents this public package API member. [JA] キー key パラメーターです。</param>
    /// <returns>[EN] Documents this public package API member. [JA] 値、キーが存在しない場合は null 結果を返します。</returns>
    string? GetContextValue(string key);

    /// <summary>
    /// EN: すべてのコンテキスト情報を取得します。
    /// [EN] Documents this public package API member. [JA] GetAllContextValues 操作を実行します。
    /// </summary>
    /// <returns>[EN] Documents this public package API member. [JA] キー-値ペアの読み取り専用辞書 結果を返します。</returns>
