...
/// EN: Documentation for public API. JA: IDynamicCapacityAxis の公開契約を定義します。
/// </summary>
...
public interface IDynamicCapacityAxis : ICapacityAxis
{
    ...
    /// EN: Documentation for public API. JA: ResolveValue 操作を実行します。
    /// </summary>
    /// <param name="constraints">EN: Documentation for public API. JA: 実行制約条件 constraints パラメーターです。</param>
    /// <returns>EN: Documentation for public API. JA: 制約下での評価軸の値（0.0 ~ 1.0） 結果を返します。</returns>
    ...
    /// EN: Documentation for public API. JA: IsApplicable 操作を実行します。
    /// </summary>
    /// <param name="constraints">EN: Documentation for public API. JA: 実行制約条件 constraints パラメーターです。</param>
    /// <returns>EN: Documentation for public API. JA: この軸が制約下で有効な場合は true 結果を返します。</returns>
