...
/// EN: Documentation for public API. JA: IRomSchemaValidator の公開契約を定義します。
/// </summary>
...
public interface IRomSchemaValidator
{
    ...
    /// EN: Documentation for public API. JA: ValidateSchemaAsync 操作を実行します。
    /// </summary>
...
/// EN: Documentation for public API. JA: IRomLinkageValidator の公開契約を定義します。
/// </summary>
...
public interface IRomLinkageValidator
{
    ...
    /// EN: Documentation for public API. JA: ValidateLinkageAsync 操作を実行します。
    /// </summary>
...
/// EN: Documentation for public API. JA: IRomTypeConsistencyValidator の公開契約を定義します。
/// </summary>
...
public interface IRomTypeConsistencyValidator
{
    ...
    /// EN: 必須プロパティ欠落も含む。
    /// EN: Documentation for public API. JA: ValidateTypeConsistencyAsync 操作を実行します。
    /// </summary>
...
/// EN: Documentation for public API. JA: IRomCircularReferenceValidator の公開契約を定義します。
/// </summary>
...
public interface IRomCircularReferenceValidator
{
    ...
    /// EN: Documentation for public API. JA: DetectCircularReferencesAsync 操作を実行します。
    /// </summary>
...
/// EN: Documentation for public API. JA: IRomValidator の公開契約を定義します。
/// </summary>
