...
/// EN: Documentation for public API. JA: IRomDocument の公開契約を定義します。
/// </summary>
...
public interface IRomDocument
{
    ...
    /// EN: Documentation for public API. JA: GetSemanticHashAsync 操作を実行します。
    /// </summary>
    ...
    /// EN: Documentation for public API. JA: GetSemanticHashAsync 操作を実行します。
    /// </summary>
    /// <returns>EN: Documentation for public API. JA: ハッシュ値（例: "sha256:a1b2c3d4..."） 結果を返します。</returns>
    Task<string> GetSemanticHashAsync();

    /// <summary>
    /// ドキュメントを正規化された形式に変換します。
    /// EN: RCS-004 の正規化処理（Linguistic, Structural, Reference Anchoring）。
    /// EN: Documentation for public API. JA: CanonicalizeAsync 操作を実行します。
    /// </summary>
    /// <returns>EN: Documentation for public API. JA: 正規化されたドキュメント表現 結果を返します。</returns>
