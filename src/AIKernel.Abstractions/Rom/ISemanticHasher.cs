...
/// [EN] Documents this public package API member. [JA] ISemanticHasher の公開契約を定義します。
/// </summary>
/// <remarks>
...
public interface ISemanticHasher
{
    ...
    /// [EN] Documents this public package API member. [JA] ComputeHash 操作を実行します。
    /// </summary>
    ...
    /// [EN] Documents this public package API member. [JA] ComputeHash 操作を実行します。
    /// </summary>
    /// <param name="canonicalized">[EN] Documents this public package API member. [JA] 正準化済み ROM データ canonicalized パラメーターです。</param>
    /// <returns>[EN] Documents this public package API member. [JA] 計算されたハッシュ値 結果を返します。</returns>
    string ComputeHash(CanonicalizedRomDto canonicalized);

    /// <summary>
    /// EN: 正準化済み ROM から意味ハッシュを非同期で計算します。
    /// [EN] Documents this public package API member. [JA] ComputeHashAsync 操作を実行します。
    /// </summary>
    /// <param name="canonicalized">[EN] Documents this public package API member. [JA] 正準化済み ROM データ canonicalized パラメーターです。</param>
    ...
    /// [EN] Documents this public package API member. [JA] VerifyHash 操作を実行します。
    /// </summary>
    /// <param name="canonicalized">[EN] Documents this public package API member. [JA] 正準化済み ROM データ canonicalized パラメーターです。</param>
    /// <param name="expectedHash">[EN] Documents this public package API member. [JA] 期待されるハッシュ値 expectedHash パラメーターです。</param>
    /// <returns>一致する場合は <see langword="true"/>、不一致の場合は <see langword="false"/>[EN] Documents this public package API member. [JA] 。 結果を返します。</returns>
    bool VerifyHash(CanonicalizedRomDto canonicalized, string expectedHash);

    /// <summary>
    /// EN: 正準化済み ROM のハッシュ値を非同期で検証します。
    /// [EN] Documents this public package API member. [JA] VerifyHashAsync 操作を実行します。
    /// </summary>
    /// <param name="canonicalized">[EN] Documents this public package API member. [JA] 正準化済み ROM データ canonicalized パラメーターです。</param>
    /// <param name="expectedHash">[EN] Documents this public package API member. [JA] 期待されるハッシュ値 expectedHash パラメーターです。</param>
    /// <param name="cancellationToken">[EN] Documents this public package API member. [JA] キャンセルトークン キャンセル通知を監視するトークンです。</param>
