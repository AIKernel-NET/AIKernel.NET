...
/// EN: Documentation for public API. JA: IQueryDecomposer の公開契約を定義します。
/// </summary>
...
public interface IQueryDecomposer
{
    ...
    /// EN: Documentation for public API. JA: DecomposeAsync 操作を実行します。
    /// </summary>
    /// <param name="query">EN: Documentation for public API. JA: 補間または正規化済みの query。 query パラメーターです。</param>
    ...
    /// <returns>EN: Documentation for public API. JA: 意味的に分解された query part の読み取り専用リスト。 結果を返します。</returns>
