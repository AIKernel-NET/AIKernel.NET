...
/// [EN] Documents this public package API member. [JA] IQueryRouter の公開契約を定義します。
/// </summary>
...
public interface IQueryRouter
{
    ...
    /// </summary>
    /// <param name="queryPart">[EN] Documents this public package API member. [JA] ルーティング対象の query part。 queryPart パラメーターです。</param>
    /// <param name="context">[EN] Documents this public package API member. [JA] 推論トランザクションの Kernel context。 context パラメーターです。</param>
    /// <param name="candidates">[EN] Documents this public package API member. [JA] 選択候補となる Provider 群。 candidates パラメーターです。</param>
    /// <param name="cancellationToken">[EN] Documents this public package API member. [JA] キャンセルトークン。 キャンセル通知を監視するトークンです。</param>
    /// <returns>[EN] Documents this public package API member. [JA] 選択された Provider。選択不能な場合は null。 結果を返します。</returns>
    ...
    /// [EN] Documents this public package API member. [JA] RouteManyAsync 操作を実行します。
    /// </summary>
    /// <param name="queryParts">[EN] Documents this public package API member. [JA] ルーティング対象の query part 群。 queryParts パラメーターです。</param>
    /// <param name="context">[EN] Documents this public package API member. [JA] 推論トランザクションの Kernel context。 context パラメーターです。</param>
    /// <param name="candidates">[EN] Documents this public package API member. [JA] 選択候補となる Provider 群。 candidates パラメーターです。</param>
    /// <param name="cancellationToken">[EN] Documents this public package API member. [JA] キャンセルトークン。 キャンセル通知を監視するトークンです。</param>
    /// <returns>[EN] Documents this public package API member. [JA] QueryPart の順序に対応する Provider 群。 結果を返します。</returns>
