...
/// EN: Documentation for public API. JA: IToolPermission の公開契約を定義します。
/// </summary>
...
public interface IToolPermission
{
    ...
    /// EN: Documentation for public API. JA: HasResourceAccess 操作を実行します。
    /// </summary>
    ...
    /// EN: Documentation for public API. JA: HasResourceAccess 操作を実行します。
    /// </summary>
    /// <param name="resourcePath">EN: Documentation for public API. JA: リソースパス resourcePath パラメーターです。</param>
    /// <returns>EN: Documentation for public API. JA: アクセス権限がある場合は true 結果を返します。</returns>
