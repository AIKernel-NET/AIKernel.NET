...
/// <summary>
/// EN: UC-15/UC-16/UC-17/UC-18 に基づく IConversationSnapshot の契約を定義します。
/// [EN] Documents this public package API member. [JA] IConversationSnapshot の公開契約を定義します。
/// </summary>
...
public interface IConversationSnapshot
{
    ...
    string BranchId { get; }
    /// <summary>EN: Gets the TimestampUtc value exposed by the AIKernel public contract surface. JA: AIKernel の公開契約サーフェスで公開される TimestampUtc 値を取得します。</summary>
    DateTimeOffset TimestampUtc { get; }
    /// <summary>EN: Gets the MessageCount value exposed by the AIKernel public contract surface. JA: AIKernel の公開契約サーフェスで公開される MessageCount 値を取得します。</summary>
