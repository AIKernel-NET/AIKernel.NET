...
{
    /// <summary>Executes the SaveDslAsRomAsync operation on the AIKernel public contract surface. JA: AIKernel の公開契約サーフェスで SaveDslAsRomAsync 操作を実行します。</summary>
    ...
    /// <summary>Executes the LoadDslRomAsync operation on the AIKernel public contract surface. JA: AIKernel の公開契約サーフェスで LoadDslRomAsync 操作を実行します。</summary>
