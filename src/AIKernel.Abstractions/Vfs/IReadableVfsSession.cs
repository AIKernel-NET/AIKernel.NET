...
/// EN: Documentation for public API. JA: IReadableVfsSession の公開契約を定義します。
/// </summary>
...
public interface IReadableVfsSession
{
    ...
    /// EN: Documentation for public API. JA: ReadReadableFileAsync 操作を実行します。
    /// </summary>
    ...
    /// <returns>EN: Documentation for public API. JA: 読み取り可能なファイル 結果を返します。</returns>
    Task<IReadableVfsFile> ReadReadableFileAsync(string path);

    /// <summary>
    /// EN: ファイル/ディレクトリが存在するかどうかを確認します。
    /// EN: Documentation for public API. JA: ExistsAsync 操作を実行します。
    /// </summary>
    /// <param name="path">EN: Documentation for public API. JA: パス path パラメーターです。</param>
    /// <returns>EN: Documentation for public API. JA: 存在する場合は true。 結果を返します。</returns>
