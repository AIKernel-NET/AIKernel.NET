...
public interface IPrincipal
{
    ...
    string GetName();
    /// <summary>EN: Executes the GetRoles operation on the AIKernel public contract surface. JA: AIKernel の公開契約サーフェスで GetRoles 操作を実行します。</summary>
    IReadOnlyList<string> GetRoles();
    /// <summary>EN: Executes the HasRole operation on the AIKernel public contract surface. JA: AIKernel の公開契約サーフェスで HasRole 操作を実行します。</summary>
