...
/// [EN] Documents this public package API member. [JA] IPolicyDecisionPoint の公開契約を定義します。
/// </summary>
...
public interface IPolicyDecisionPoint
{
    ...
    /// </summary>
    /// <param name="request">[EN] Documents this public package API member. [JA] アクセス決定リクエスト request パラメーターです。</param>
    /// <returns>[EN] Documents this public package API member. [JA] アクセス決定結果 結果を返します。</returns>
    Task<AccessDecision> EvaluateAsync(AccessRequest request);
}

/// <summary>
/// EN: Policy registry を管理する契約です。
/// [EN] Documents this public package API member. [JA] IPolicyRegistry の公開契約を定義します。
/// </summary>
...
public interface IPolicyRegistry
{
    /// <summary>
    /// EN: ポリシーを追加します。
    /// [EN] Documents this public package API member. [JA] AddPolicy 操作を実行します。
    /// </summary>
    /// <param name="policy">[EN] Documents this public package API member. [JA] 追加するポリシー policy パラメーターです。</param>
    void AddPolicy(IPolicy policy);

    /// <summary>
    /// EN: ポリシーを削除します。
    /// [EN] Documents this public package API member. [JA] RemovePolicy 操作を実行します。
    /// </summary>
    /// <param name="policyId">[EN] Documents this public package API member. [JA] ポリシーID policyId パラメーターです。</param>
    bool RemovePolicy(string policyId);
}

/// <summary>
/// EN: Policy source を公開する契約です。
/// [EN] Documents this public package API member. [JA] IPolicySource の公開契約を定義します。
/// </summary>
...
public interface IPolicySource
{
    /// <summary>
    /// EN: ポリシー一覧を取得します。
    /// [EN] Documents this public package API member. [JA] GetPolicies 操作を実行します。
    /// </summary>
...
/// [EN] Documents this public package API member. [JA] IPolicyDecisionEvaluator の公開契約を定義します。
/// </summary>
...
public interface IPolicyDecisionEvaluator
{
    ...
    /// [EN] Documents this public package API member. [JA] EvaluatePoliciesAsync 操作を実行します。
    /// </summary>
    /// <param name="contract">[EN] Documents this public package API member. [JA] コンテキスト契約 contract パラメーターです。</param>
    /// <returns>[EN] Documents this public package API member. [JA] ポリシー評価結果 結果を返します。</returns>
...
/// [EN] Documents this public package API member. [JA] IPdp の公開契約を定義します。
/// </summary>
