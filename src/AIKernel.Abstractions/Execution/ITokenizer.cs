...
/// EN: Documentation for public API. JA: ITokenizerIdentity の公開契約を定義します。
/// </summary>
...
public interface ITokenizerIdentity
{
    ...
    /// <summary>
    /// EN: トークナイザーの名前を取得します。
    /// EN: Documentation for public API. JA: ITextTokenizer の公開契約を定義します。
    /// </summary>
    string Name { get; }
}
...
public interface ITextTokenizer
{
    /// <summary>
    /// EN: テキストをトークン化します。
    /// EN: Documentation for public API. JA: Tokenize 操作を実行します。
    /// </summary>
    /// <param name="text">EN: Documentation for public API. JA: トークン化するテキスト text パラメーターです。</param>
    /// <returns>EN: Documentation for public API. JA: トークンリスト 結果を返します。</returns>
...
/// EN: Documentation for public API. JA: ITokenCounter の公開契約を定義します。
/// </summary>
...
public interface ITokenCounter
{
    /// <summary>
    /// EN: テキストのトークン数を計算します。
    /// EN: Documentation for public API. JA: CountTokens 操作を実行します。
    /// </summary>
    /// <param name="text">EN: Documentation for public API. JA: テキスト text パラメーターです。</param>
    /// <returns>EN: Documentation for public API. JA: トークン数 結果を返します。</returns>
...
/// EN: Documentation for public API. JA: ITokenDecoder の公開契約を定義します。
/// </summary>
...
public interface ITokenDecoder
{
    ...
    /// EN: Documentation for public API. JA: Decode 操作を実行します。
    /// </summary>
    /// <param name="tokens">EN: Documentation for public API. JA: トークンリスト tokens パラメーターです。</param>
    /// <returns>EN: Documentation for public API. JA: デコードされたテキスト 結果を返します。</returns>
...
/// EN: Documentation for public API. JA: ITokenizerStatisticsProvider の公開契約を定義します。
/// </summary>
...
public interface ITokenizerStatisticsProvider
{
    ...
    /// EN: Documentation for public API. JA: GetStatistics 操作を実行します。
    /// </summary>
    /// <returns>EN: Documentation for public API. JA: 統計情報 結果を返します。</returns>
...
/// EN: Documentation for public API. JA: ITokenizerModelSupport の公開契約を定義します。
/// </summary>
...
public interface ITokenizerModelSupport
{
    ...
    /// EN: Documentation for public API. JA: SupportsModel 操作を実行します。
    /// </summary>
    /// <param name="modelName">EN: Documentation for public API. JA: モデル名 modelName パラメーターです。</param>
...
/// EN: Documentation for public API. JA: IPhysicalCardinalityAdvisor の公開契約を定義します。
/// </summary>
...
public interface IPhysicalCardinalityAdvisor
{
    ...
    /// EN: Documentation for public API. JA: GetPhysicalCardinality 操作を実行します。
    /// </summary>
    /// <param name="logicalTokenCount">EN: Documentation for public API. JA: 論理的なトークン数 logicalTokenCount パラメーターです。</param>
    /// <param name="deviceType">EN: Documentation for public API. JA: デバイスタイプ（"NPU", "GPU", "CPU"等） deviceType パラメーターです。</param>
    /// <returns>EN: Documentation for public API. JA: NPU最適化後の物理基数 結果を返します。</returns>
...
/// EN: Documentation for public API. JA: IPaddingInfoProvider の公開契約を定義します。
/// </summary>
...
public interface IPaddingInfoProvider
{
    ...
    /// EN: Documentation for public API. JA: GetPaddingInfo 操作を実行します。
    /// </summary>
    /// <param name="logicalTokenCount">EN: Documentation for public API. JA: 論理的なトークン数 logicalTokenCount パラメーターです。</param>
    /// <param name="physicalCardinality">EN: Documentation for public API. JA: 物理基数 physicalCardinality パラメーターです。</param>
    /// <returns>EN: Documentation for public API. JA: パディング情報 結果を返します。</returns>
...
/// EN: Documentation for public API. JA: ITokenizer の公開契約を定義します。
/// </summary>
