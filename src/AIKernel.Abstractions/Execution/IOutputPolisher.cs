...
/// [EN] Documents this public package API member. [JA] IOutputPolisher の公開契約を定義します。
/// </summary>
...
public interface IOutputPolisher
{
    ...
    /// [EN] Documents this public package API member. [JA] RenderAsync 操作を実行します。
    /// </summary>
    ...
    /// [EN] Documents this public package API member. [JA] RenderAsync 操作を実行します。
    /// </summary>
    /// <param name="logic">[EN] Documents this public package API member. [JA] 推論結果の中間表現 logic パラメーターです。</param>
    /// <param name="expressionContext">[EN] Documents this public package API member. [JA] 表現・整形の文脈 expressionContext パラメーターです。</param>
    /// <param name="ct">[EN] Documents this public package API member. [JA] キャンセルトークン ct パラメーターです。</param>
    /// <returns>[EN] Documents this public package API member. [JA] 最終出力（整形済みテキスト） 結果を返します。</returns>
