...
{
    /// <summary>Gets the StepId value exposed by the AIKernel public contract surface. JA: AIKernel の公開契約サーフェスで公開される StepId 値を取得します。</summary>
    string StepId { get; }
    /// <summary>Gets the DependsOn value exposed by the AIKernel public contract surface. JA: AIKernel の公開契約サーフェスで公開される DependsOn 値を取得します。</summary>
