...
/// [EN] Documents this public package API member. [JA] IKernelReplayer の公開契約を定義します。
/// </summary>
/// <remarks>
...
public interface IKernelReplayer
{
    ...
    /// [EN] Documents this public package API member. [JA] ReplayAsync 操作を実行します。
    /// </summary>
    /// <param name="replayDump">[EN] Documents this public package API member. [JA] 再実行対象のダンプ replayDump パラメーターです。</param>
    /// <param name="traceContext">[EN] Documents this public package API member. [JA] トレース情報 traceContext パラメーターです。</param>
    ...
    /// [EN] Documents this public package API member. [JA] CanReplay 操作を実行します。
    /// </summary>
    /// <param name="replayDump">[EN] Documents this public package API member. [JA] 判定対象のダンプ replayDump パラメーターです。</param>
    /// <returns>再実行可能な場合は <see langword="true"/>、それ以外は <see langword="false"/>[EN] Documents this public package API member. [JA] 。 結果を返します。</returns>
