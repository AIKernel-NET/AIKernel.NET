...
/// [EN] Documents this public package API member. [JA] IExecutionOutput の公開契約を定義します。
/// </summary>
...
public interface IExecutionOutput
{
    ...
    /// [EN] Documents this public package API member. [JA] GetSerializedRepresentation 操作を実行します。
    /// </summary>
    ...
    /// [EN] Documents this public package API member. [JA] このメンバー の公開契約を定義します。
    /// </summary>
    /// <typeparam name="TOutput">[EN] Documents this public package API member. [JA] 変換先の出力型 TOutput 型パラメーターです。</typeparam>
    /// <returns>[EN] Documents this public package API member. [JA] 変換後の出力オブジェクト 結果を返します。</returns>
