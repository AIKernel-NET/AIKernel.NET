...
/// <summary>
/// EN: UC-02/UC-04/UC-09/UC-20/UC-22 に基づく IStructurePlanner の契約を定義します。
/// [EN] Documents this public package API member. [JA] IStructurePlanner の公開契約を定義します。
/// </summary>
...
public interface IStructurePlanner
{
    ...
    string Name { get; }
    /// <summary>EN: Executes the PlanAsync operation on the AIKernel public contract surface. JA: AIKernel の公開契約サーフェスで PlanAsync 操作を実行します。</summary>
    Task<IReadOnlyList<string>> PlanAsync(Context.IContextCollection orchestrationContext, CancellationToken ct = default);
    /// <summary>EN: Executes the EstimateComplexity operation on the AIKernel public contract surface. JA: AIKernel の公開契約サーフェスで EstimateComplexity 操作を実行します。</summary>
