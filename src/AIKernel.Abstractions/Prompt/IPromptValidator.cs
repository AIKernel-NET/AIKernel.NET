...
/// <summary>
/// EN: UC-11/UC-12/UC-13 に基づく IPromptValidator の契約を定義します。
/// [EN] Documents this public package API member. [JA] IPromptValidator の公開契約を定義します。
/// </summary>
...
{
    /// <summary>EN: Executes the ValidateAsync operation on the AIKernel public contract surface. JA: AIKernel の公開契約サーフェスで ValidateAsync 操作を実行します。</summary>
