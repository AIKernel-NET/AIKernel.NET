...
/// JA: IPromptRepository の公開契約を定義します。
/// </summary>
...
{
    /// <summary>Executes the GetSignedPromptArtifactAsync operation on the AIKernel public contract surface. JA: AIKernel の公開契約サーフェスで GetSignedPromptArtifactAsync 操作を実行します。</summary>
