...
Provider configuration is package-owned and should not be guessed globally.

### JA

Provider Configuration は 0.1.2 の repository metadata、package metadata、既存 docs を根拠に説明します。
