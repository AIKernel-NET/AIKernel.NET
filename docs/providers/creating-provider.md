...
A provider should bring its package metadata, tests, and docs evidence together.

### JA

Creating Providers は 0.1.2 の repository metadata、package metadata、既存 docs を根拠に説明します。
