...
(See: [Attention Pollution Theory](3.ATTENTION_POLLUTION_THEORY.md))
...
(See: [Risks of Surface-Mode Failure](4.LLM_SURFACE_MODE_FAILURE.md))
...
(See: [Principles of Information Category Separation](1.CATEGORY_SEPARATION_PRINCIPLES.md))
...
(See: [Context Isolation Specification](2.CONTEXT_ISOLATION_SPEC.md))
