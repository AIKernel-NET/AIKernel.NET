...
v0.0.5 adds shared DTO/enum vocabulary for pre-inference admissibility replay records, trajectory governance evidence records, and Semantic IR G/T/C/B slots.
