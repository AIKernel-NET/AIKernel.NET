...
Japanese version: [Semantic Context OS ビジョン](16.SEMANTIC_CONTEXT_OS_VISION-jp.md)
...
## 6. Related Documents
- [Principles of Information Category Separation](1.CATEGORY_SEPARATION_PRINCIPLES.md)
- [Context Isolation Specification](2.CONTEXT_ISOLATION_SPEC.md)
- [Attention Pollution Theory](3.ATTENTION_POLLUTION_THEORY.md)
