...
## ドキュメント一覧
- [IComputeShapeAdvisor](../execution/IComputeShapeAdvisor-jp.md)
- [IOutputPolisher (インターフェース仕様)](../execution/IOutputPolisher-jp.md)
- [IThoughtProcess (インターフェース仕様)](../execution/IThoughtProcess-jp.md)
- [ITokenizer](../execution/ITokenizer-jp.md)
---
