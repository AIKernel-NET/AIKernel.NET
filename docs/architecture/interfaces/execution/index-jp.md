...
## ドキュメント一覧
- [IComputeShapeAdvisor](architecture/interfaces/execution/IComputeShapeAdvisor-jp.md)
- [IOutputPolisher (インターフェース仕様)](architecture/interfaces/execution/IOutputPolisher-jp.md)
- [IThoughtProcess (インターフェース仕様)](architecture/interfaces/execution/IThoughtProcess-jp.md)
- [ITokenizer](architecture/interfaces/execution/ITokenizer-jp.md)
---
