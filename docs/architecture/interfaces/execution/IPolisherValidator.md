...
For Japanese version, see [IPolisherValidator-jp.md](./IPolisherValidator-jp.md).

# IPolisherValidator

## 1. Responsibility Boundary
$n defines: Validation contract for polished outputs before release.
