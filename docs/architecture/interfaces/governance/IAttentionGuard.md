...
Japanese version: [IAttentionGuard](architecture/interfaces/governance/IAttentionGuard-jp.md)

# IAttentionGuard

## Responsibility
Define the contract boundary for IAttentionGuard within AIKernel orchestration and governance flows.
...
## Related Use Cases
See ../../use-cases/AIKernel_UseCaseCatalog.md for references where IAttentionGuard appears.
