...
英語版は IAttentionGuard.md を参照。

# IAttentionGuard

## Responsibility
IAttentionGuard が AIKernel のオーケストレーションおよび統治フローで担う契約境界を定義する。
...
## 関連ユースケース
../../use-cases/AIKernel_UseCaseCatalog-jp.md の IAttentionGuard 参照箇所を基準とする。
