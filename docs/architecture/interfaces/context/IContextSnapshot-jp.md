...
英語版は IContextSnapshot.md を参照。

# IContextSnapshot

## Responsibility
IContextSnapshot が AIKernel のオーケストレーションおよび統治フローで担う契約境界を定義する。
...
## 関連ユースケース
../../use-cases/AIKernel_UseCaseCatalog-jp.md の IContextSnapshot 参照箇所を基準とする。
