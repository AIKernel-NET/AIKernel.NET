...
英語版は IInputNormalizer.md を参照。

# IInputNormalizer

## Responsibility
IInputNormalizer が AIKernel のオーケストレーションおよび統治フローで担う契約境界を定義する。
...
## 関連ユースケース
../../use-cases/AIKernel_UseCaseCatalog-jp.md の IInputNormalizer 参照箇所を基準とする。
