...
For Japanese version, see IContextCategory-jp.md.

# IContextCategory

## Responsibility
Define the contract boundary for IContextCategory within AIKernel orchestration and governance flows.
...
## Related Use Cases
See ../../use-cases/AIKernel_UseCaseCatalog.md for references where IContextCategory appears.
