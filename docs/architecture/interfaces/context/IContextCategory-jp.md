...
英語版は IContextCategory.md を参照。

# IContextCategory

## Responsibility
IContextCategory が AIKernel のオーケストレーションおよび統治フローで担う契約境界を定義する。
...
## 関連ユースケース
../../use-cases/AIKernel_UseCaseCatalog-jp.md の IContextCategory 参照箇所を基準とする。
