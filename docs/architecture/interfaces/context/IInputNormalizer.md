...
For Japanese version, see IInputNormalizer-jp.md.

# IInputNormalizer

## Responsibility
Define the contract boundary for IInputNormalizer within AIKernel orchestration and governance flows.
...
## Related Use Cases
See ../../use-cases/AIKernel_UseCaseCatalog.md for references where IInputNormalizer appears.
