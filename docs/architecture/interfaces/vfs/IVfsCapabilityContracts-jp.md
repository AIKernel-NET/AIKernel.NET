...
これらの contract は公開 namespace `AIKernel.Vfs` を維持したまま、`AIKernel.Abstractions` が所有する。個別の `AIKernel.Vfs` 互換 package は v0.0.4 で削除された。
...
- v0.0.4 (2026-06-04): 公開 namespace を維持したまま個別の AIKernel.Vfs 互換 package 注記を削除
