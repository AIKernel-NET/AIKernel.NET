...
For Japanese version, see [IKernel-jp.md](./IKernel-jp.md).

# IKernel

## 1. Responsibility Boundary
$n defines: Kernel entry boundary for orchestrated execution.

## 2. Related Use Cases
- UC-08, UC-29

## 3. Related Specs
- 01.EXECUTION_PIPELINE_SPEC, 16.SEMANTIC_CONTEXT_OS_VISION
