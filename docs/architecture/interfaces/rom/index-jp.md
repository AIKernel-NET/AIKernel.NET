...
## ドキュメント一覧
- [IRomCanonicalizer (ROM 正準化インターフェース仕様)](../rom/IRomCanonicalizer-jp.md)
- [ISemanticHasher (セマンティックハッシュ・インターフェース仕様)](../rom/ISemanticHasher-jp.md)
- [IRomDocument (ROM ドキュメント仕様)](../rom/IRomDocument-jp.md)
- [IRomValidator (ROM バリデーター仕様)](../rom/IRomValidator-jp.md)
- [IRelationResolver (関係解決インターフェース仕様)](../rom/IRelationResolver-jp.md)
---
