...
For Japanese version, see [ITaskExecutionResult-jp.md](./ITaskExecutionResult-jp.md).

# ITaskExecutionResult

## 1. Responsibility Boundary
$n defines: Task execution result contract including status and payload.
