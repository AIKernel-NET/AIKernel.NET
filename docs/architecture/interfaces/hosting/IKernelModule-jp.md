...
英語版: [IKernelModule](architecture/interfaces/hosting/IKernelModule.md)

# IKernelModule

## Responsibility
IKernelModule が AIKernel のオーケストレーションおよび統治フローで担う契約境界を定義する。
...
## 関連ユースケース
../../use-cases/AIKernel_UseCaseCatalog-jp.md の IKernelModule 参照箇所を基準とする。
