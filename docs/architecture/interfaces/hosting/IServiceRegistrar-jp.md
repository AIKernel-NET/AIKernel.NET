...
英語版は IServiceRegistrar.md を参照。

# IServiceRegistrar

## Responsibility
IServiceRegistrar が AIKernel のオーケストレーションおよび統治フローで担う契約境界を定義する。
...
## 関連ユースケース
../../use-cases/AIKernel_UseCaseCatalog-jp.md の IServiceRegistrar 参照箇所を基準とする。
