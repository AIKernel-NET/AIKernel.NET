...
For Japanese version, see IKernelContext-jp.md.

# IKernelContext

## Responsibility
Define the contract boundary for IKernelContext within AIKernel orchestration and governance flows.
...
## Related Use Cases
See ../../use-cases/AIKernel_UseCaseCatalog.md for references where IKernelContext appears.
