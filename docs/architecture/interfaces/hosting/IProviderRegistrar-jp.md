...
英語版: [IProviderRegistrar](architecture/interfaces/hosting/IProviderRegistrar.md)

# IProviderRegistrar

## Responsibility
IProviderRegistrar が AIKernel のオーケストレーションおよび統治フローで担う契約境界を定義する。
...
## 関連ユースケース
../../use-cases/AIKernel_UseCaseCatalog-jp.md の IProviderRegistrar 参照箇所を基準とする。
