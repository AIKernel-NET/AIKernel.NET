...
For Japanese version, see IKernelModule-jp.md.

# IKernelModule

## Responsibility
Define the contract boundary for IKernelModule within AIKernel orchestration and governance flows.
...
## Related Use Cases
See ../../use-cases/AIKernel_UseCaseCatalog.md for references where IKernelModule appears.
