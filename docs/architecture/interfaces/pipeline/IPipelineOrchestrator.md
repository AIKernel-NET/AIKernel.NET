...
For Japanese version, see IPipelineOrchestrator-jp.md.

# IPipelineOrchestrator

## Responsibility
Define the contract boundary for IPipelineOrchestrator within AIKernel orchestration and governance flows.
...
## Related Use Cases
See ../../use-cases/AIKernel_UseCaseCatalog.md for references where IPipelineOrchestrator appears.
