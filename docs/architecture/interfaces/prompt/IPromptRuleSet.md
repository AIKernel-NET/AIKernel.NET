...
For Japanese version, see IPromptRuleSet-jp.md.

# IPromptRuleSet

## Responsibility
Define the contract boundary for IPromptRuleSet within AIKernel orchestration and governance flows.
...
## Related Use Cases
See ../../use-cases/AIKernel_UseCaseCatalog.md for references where IPromptRuleSet appears.
