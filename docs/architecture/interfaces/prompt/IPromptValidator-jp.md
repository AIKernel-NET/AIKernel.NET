...
英語版は IPromptValidator.md を参照。

# IPromptValidator

## Responsibility
IPromptValidator が AIKernel のオーケストレーションおよび統治フローで担う契約境界を定義する。
...
## 関連ユースケース
../../use-cases/AIKernel_UseCaseCatalog-jp.md の IPromptValidator 参照箇所を基準とする。
