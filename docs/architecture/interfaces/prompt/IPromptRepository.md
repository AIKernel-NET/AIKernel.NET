---
id: ipromptrepository
title: "IPromptRepository"
created: 2026-05-03
updated: 2026-05-16
...
Japanese version: [IPromptRepository](architecture/interfaces/prompt/IPromptRepository-jp.md)

# IPromptRepository

## Responsibility
Define the contract boundary for IPromptRepository within AIKernel orchestration and governance flows.
...
## Related Use Cases
See ../../use-cases/AIKernel_UseCaseCatalog.md for references where IPromptRepository appears.
