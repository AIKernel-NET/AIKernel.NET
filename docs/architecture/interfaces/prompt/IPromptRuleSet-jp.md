...
英語版は IPromptRuleSet.md を参照。

# IPromptRuleSet

## Responsibility
IPromptRuleSet が AIKernel のオーケストレーションおよび統治フローで担う契約境界を定義する。
...
## 関連ユースケース
../../use-cases/AIKernel_UseCaseCatalog-jp.md の IPromptRuleSet 参照箇所を基準とする。
