...
For Japanese version, see [IProviderRouter-jp.md](./IProviderRouter-jp.md).

# IProviderRouter

## 1. Responsibility Boundary
$n defines: Provider-level routing abstraction bridging model decisions and provider dispatch.
