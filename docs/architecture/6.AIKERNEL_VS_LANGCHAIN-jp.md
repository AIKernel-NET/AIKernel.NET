...
（参照: [Attention Pollution 理論](3.ATTENTION_POLLUTION_THEORY-jp.md)）
...
（参照: [Surface-Mode Failure のリスク](4.LLM_SURFACE_MODE_FAILURE-jp.md)）
...
## 2.1 情報カテゴリ分離  
（参照: [情報カテゴリ分離の原則](1.CATEGORY_SEPARATION_PRINCIPLES-jp.md)）
...
## 2.2 コンテキスト隔離  
（参照: [コンテキスト分離仕様](2.CONTEXT_ISOLATION_SPEC-jp.md)）
