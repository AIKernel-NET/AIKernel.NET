...
v0.0.5 では、pre-inference admissibility replay / profile / budget / result record、trajectory governance evidence record、Semantic IR G/T/C/B slot の共有 DTO / enum vocabulary を追加する。
