...
Semantic Compilation DTO は、observable semantic state、Semantic IR element、governed circuit descriptor、semantic transition を運ぶ contract-only carrier も提供する。
