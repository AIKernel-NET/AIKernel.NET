...
英語版: [Semantic Context OS Vision](architecture/16.SEMANTIC_CONTEXT_OS_VISION.md)
...
## 6. Related Documents
- [情報カテゴリ分離の原則](architecture/1.CATEGORY_SEPARATION_PRINCIPLES-jp.md)
...
- [DI Composition and Pipeline Bootstrap](architecture/7.DI_COMPOSITION_AND_PIPELINE_BOOTSTRAP-jp.md)
- [Execution Contract Architecture](architecture/8.EXECUTION_CONTRACT_ARCHITECTURE-jp.md)
- [PDP Guard Decision Plane](architecture/9.PDP_GUARD_DECISION_PLANE-jp.md)
- [Signed Prompt Governance Workflow](architecture/14.SIGNED_PROMPT_GOVERNANCE_WORKFLOW-jp.md)
