...
（参照: [Principles of Information Category Separation](1.CATEGORY_SEPARATION_PRINCIPLES.md)）

## 3.2 Context isolation
（参照: [Context Isolation Specification](2.CONTEXT_ISOLATION_SPEC.md)）
...
- [AIKernel vs LangChain — Structural Comparison](6.AIKERNEL_VS_LANGCHAIN.md)
---
