...
This page explains extensions using repository metadata and links to the generated Reference.

### JA

このページでは Extensions を repository metadata と generated Reference に基づいて説明します。
...
Extension examples include `AIKernel.Providers.Audio`, `AIKernel.Tools.Capability.RomStorage`, `AIKernel.Wasm.Audio`, and `DoomCapabilities`.
...
- Extension は package の独立性と審査可能な Reference を保つために分離します。
