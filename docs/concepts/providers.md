...
This page explains providers using repository metadata and links to the generated Reference.

### JA

このページでは Providers を repository metadata と generated Reference に基づいて説明します。
...
`AIKernel.Providers` contains 12 NuGet packages and 1 Python package entries.
...
- Provider は外部機能や model/capability を Core に直接混ぜないための境界です。
