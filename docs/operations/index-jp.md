...
- v0.1.1.1 は .NET / NuGet のみの package boundary とし、この line では PyPI package を作成しない
...
### 8. [CTG ROM Layout](CTG_ROM_LAYOUT-v0.1.1.1-jp.md)
**ステータス:** Active
**現在の内容:**
...
### 10. Monitoring & Observability（監視・可観測性）
**ステータス:** Planned
**内容（予定）:**
...
### 12. Security Operations（セキュリティ運用）
**ステータス:** Planned
**内容（予定）:**
...
- Package Installation Guide は同期済み `0.1.1` の NuGet / PyPI line と、`0.1.1.1` の NuGet-only contract update を扱う
- Demo Programs Guide は公式 AIKernel.Demo の学習導線を扱う
- Interface naming、enum handling、XML documentation policy、CTG developer guidance、CTG ROM layout は v0.1.1.1 additive contract surface を扱う
...
- v0.1.1.1 (2026-06-14): CTG developer guide、Monolith CTG-ROM layout coverage、0.1.1.1 の NuGet-only package boundary を追加
