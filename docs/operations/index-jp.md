...
### 9. Monitoring & Observability（監視・可観測性）
**ステータス:** Planned
**内容（予定）:**
...
### 11. Security Operations（セキュリティ運用）
**ステータス:** Planned
**内容（予定）:**
...
- Interface naming、enum handling、XML documentation policy、CTG developer guidance は v0.1.1.1 additive contract surface を扱う
...
- v0.1.1.1 (2026-06-14): CTG developer guide coverage を追加
