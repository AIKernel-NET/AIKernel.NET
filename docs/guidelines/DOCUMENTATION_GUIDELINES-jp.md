...
- Keep heading levels, bullet counts, and code-block content aligned between Japanese and japanese.
...
When stable, reflect changes into japanese and update SemVer.
...
## 3.1 Emoji usage
- japanese README: limited emoji allowed with accompanying text (e.g., ✔ / ❌ plus the word)
...
- Include japanese terms for technical words
