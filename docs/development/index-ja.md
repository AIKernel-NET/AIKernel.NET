...
# AIKernel Development Notes

この directory は、AIKernel.NET と実装リポジトリで共有する横断的な development note を
配置する場所です。
...
5. [Interface Breaking Change Check v0.1.2](interface-breaking-change-check-v0.1.2-ja.md)
6. [Package Release Alignment v0.1.2](package-release-alignment-v0.1.2-ja.md)
