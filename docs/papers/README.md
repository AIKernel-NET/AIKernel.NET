...
さらに **Canonical Trajectory Governance（12）** が追加され、Logos / Ethos / Pathos の三評議会、Ethos veto、strictly-positive council gate、CTG-ROM persona portability、PPM / HATL との責務分離が Zenodo 公開論文として整理されました。
...
- **Deterministic Governance / Persona OS（12）** CTG three-council gateway と CTG-ROM persona portability
...
## **Deterministic Governance / Persona OS（12）**

|番号|タイトル|概要|
|---|---|---|
|**12**|AIKernel Canonical Trajectory Governance (CTG)<br>**DOI:** https://doi.org/10.5281/zenodo.20681895|Logos / Ethos / Pathos の three-council gateway、Ethos canonical veto、finite discrete gate、trajectory product semantics、CTG-ROM persona portability、PPM / HATL との責務分離を定義する。|
...
|**Deterministic Governance / Persona OS（12）**|実行境界の決定論的統治|CTG による discrete gate、Ethos veto、CTG-ROM persona portability、GovernanceTrace auditability。|
...
docs/
  papers/
    ...
    12-canonical-trajectory-governance/
```
...
5. **Deterministic Governance / Persona OS（12）** を CTG contract / ROM governance / trace auditability の理論的基盤として維持
    
6. 各 Paper は独立した DOI 論文として Zenodo に登録
    
7. README はフェーズ境界と更新履歴を明示
