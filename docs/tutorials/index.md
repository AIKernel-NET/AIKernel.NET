...
title: "Tutorials"
lang: ja
description: "AIKernel.NET 0.1.3 を段階的に試すための tutorial 入口です。"
...
Choose a tutorial by workflow: install, first kernel, provider, tool, Wasm, or Doom.

### JA

Tutorials は、0.1.3 公式サイトで迷わず実作業へ進むための tutorial です。
