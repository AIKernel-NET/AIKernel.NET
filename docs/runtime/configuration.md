...
title: "Configuration"
lang: ja
description: "0.1.3 package version、provider options、CUDA runtime path、Doom consent asset の configuration boundary を説明します。"
...
Configuration belongs close to the package that owns the behavior.

### JA

Configuration は 0.1.3 の repository metadata、package metadata、既存 docs を根拠に説明します。
