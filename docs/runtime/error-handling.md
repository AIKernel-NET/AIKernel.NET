...
Error handling must be read from source and tests, not inferred from package names.

### JA

Error Handling は 0.1.3 の repository metadata、package metadata、既存 docs を根拠に説明します。
