...
Lifecycle is described as phases because repositories own different parts of the runtime.

### JA

Lifecycle は 0.1.2 の repository metadata、package metadata、既存 docs を根拠に説明します。
